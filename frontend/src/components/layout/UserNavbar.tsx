                ...
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
                  ...
                  {user?.role === 'admin' && (
                    <div className="border-t border-gray-100 py-1">
                      ...
                      <Link to="/admin/cli-proxy" className="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50" onClick={() => setUserDropdownOpen(false)}>
                        <svg className="w-4 h-4 mr-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="px-4 py-4 space-y-1">
            ...
            {user?.role === 'admin' && (
              <>
                ...
                <Link to="/admin/cli-proxy" className={mobileLinkClass('/admin/cli-proxy')} onClick={() => setMobileMenuOpen(false)}>{t.nav.cliProxy}</Link>
