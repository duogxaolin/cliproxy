                ...
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
                  ...
                  {user?.role === 'admin' && (
                    <div className="border-t border-gray-100 py-1">
                      <Link to="/admin" className="flex items-center px-4 py-2 text-sm text-primary-700 hover:bg-primary-50" onClick={() => setUserDropdownOpen(false)}>
        ...
        <div className="md:hidden border-t border-gray-100 bg-white animate-slide-down">
          <div className="px-4 py-4 space-y-1">
            ...
            {user?.role === 'admin' && (
              <>
                <div className="border-t border-gray-100 my-2" />
                <Link to="/admin" className="block px-4 py-3 rounded-lg text-base font-medium text-primary-700 bg-primary-50" onClick={() => setMobileMenuOpen(false)}>
                  {t.nav.adminPanel}
                </Link>
              </>
            )}
